...
local REPLACE_MANY_FUNC_NAME = 'replace_many_on_storage_v2'
local REPLACE_MANY_LEGACY_FUNC_NAME = 'replace_many_on_storage'
local CRUD_REPLACE_MANY_FUNC_NAME = utils.get_storage_call(REPLACE_MANY_FUNC_NAME)

local function replace_many_on_storage_v2(space_name, tuples, opts)
...
replace_many.storage_api = {
    [REPLACE_MANY_FUNC_NAME] = replace_many_on_storage_v2,
    [REPLACE_MANY_LEGACY_FUNC_NAME] = replace_many_on_storage,
}
