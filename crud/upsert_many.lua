...
local UPSERT_MANY_FUNC_NAME = 'upsert_many_on_storage_v2'
local UPSERT_MANY_LEGACY_FUNC_NAME = 'upsert_many_on_storage'
local CRUD_UPSERT_MANY_FUNC_NAME = utils.get_storage_call(UPSERT_MANY_FUNC_NAME)

local function upsert_many_on_storage_v2(space_name, tuples, operations, opts)
...
upsert_many.storage_api = {
    [UPSERT_MANY_FUNC_NAME] = upsert_many_on_storage_v2,
    [UPSERT_MANY_LEGACY_FUNC_NAME] = upsert_many_on_storage,
}
