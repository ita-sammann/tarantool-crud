...
local INSERT_MANY_FUNC_NAME = 'insert_many_on_storage_v2'
local INSERT_MANY_LEGACY_FUNC_NAME = 'insert_many_on_storage'
local CRUD_INSERT_MANY_FUNC_NAME = utils.get_storage_call(INSERT_MANY_FUNC_NAME)

local function insert_many_on_storage_v2(space_name, tuples, opts)
...
insert_many.storage_api = {
    [INSERT_MANY_FUNC_NAME] = insert_many_on_storage_v2,
    [INSERT_MANY_LEGACY_FUNC_NAME] = insert_many_on_storage,
}
